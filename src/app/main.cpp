...
int main() {
  ...
  sf::VertexArray rc{sf::PrimitiveType::TriangleStrip, quality*4};

  const sf::Vector2<unsigned int> size = window.getSize();

  sf::CircleShape a{10.f, 40};
  a.setOrigin(sf::Vector2f{size.y*0.3f, 60.f});
  ...
  while (window.isOpen()) {
    ...
    Creates::CreateRoundedRect(rc, quality*4 , 10.f, sf::Vector2f{100.f,100.f}, sf::Vector2f{300.f,300.f}, sf::Color{255,255,255});
